...
export function compact(
  ...
  cols: number,
  nonCollisionFlag: ?boolean = false,
): Layout {
  // [!! HACK !!] :: When non-collision then diable compact !!!
  if(nonCollisionFlag === true) 
     return layout;
...
export function synchronizeLayoutWithChildren(
  ...
  layout = compact(layout, compactType, cols, nonCollisionFlag);
