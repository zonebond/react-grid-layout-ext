...
// HACK ??
import { ElementBus } from './GridItem'
// HACK ??
...
export default class ReactGridLayout extends React.Component<Props, State> {
  ...
  static propTypes = {
    ...
    // [!! HACK !!] disableCollision >> force open or cloase collision feature.
    disableCollision: PropTypes.bool,
  ...
  componentDidMount() {
    ...
    const onElementBusInstanced = this.props.onElementBusInstanced;
    if(typeof onElementBusInstanced === 'function') {
      onElementBusInstanced(ElementBus);
    }
    // HACK ??
  }
  ...
  onDrag(i: string, x: number, y: number, { e, node }: GridDragEvent) {
    ...
    this.setState({
      layout: compact(layout, this.compactType(), cols, this.props.disableCollision),
  ...
  onDragStop(i: string, x: number, y: number, { e, node }: GridDragEvent) {
    ...
    // Set state
    const newLayout = compact(layout, this.compactType(), cols, this.props.disableCollision);
  ...
  onResize(i: string, w: number, h: number, { e, node }: GridResizeEvent) {
    ...
    let hasCollisions;
    if (preventCollision && !this.props.disableCollision) {
  ...
  componentDidUpdate() {
    ElementBus.notification('update');
  }
  // HACK ??
